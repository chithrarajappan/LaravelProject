...
<head>
    ...
    <title>ExamLaravel-Dashbord</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{URL::to('dashbord')}}"> {{Auth::user()->name}}</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="{{action('DashbordController@profile', $uname)}}"><i class="fa fa-user fa-fw"></i> User Profile</a>
                        </li>
                        <li class="divider"></li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{URL::to('dashbord')}}"><i class="fa fa-dashboard fa-fw"></i>Home</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Charts<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{URL::to('flot')}}">Flot Charts</a>
                                </li>
                                <li>
                                    <a href="{{URL::to('morris')}}">Morris.js Charts</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="{{URL::to('alluser')}}"><i class="fa fa-user fa-fw"></i> All Users</a>
                        </li>
                        <li>
    ...
    <script src="{{URL::to('vendor/flot/excanvas.min.js')}}"></script>
    ...
    <script src="{{URL::to('vendor/flot-tooltip/jquery.flot.tooltip.min.js')}}"></script>
    <script src="{{URL::to('data/flot-data.js')}}"></script>
  ...
  <!-- DataTables JavaScript -->
    ...
    <!-- Page-Level Demo Scripts - Tables - Use for reference --><div id="page-wrapper">
    <script>
